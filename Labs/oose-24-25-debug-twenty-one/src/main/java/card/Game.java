...
public abstract class Game <ExtendedENum extends Enum<ExtendedENum>> {
    ...
    public final static String numberOfCompetitors = "How many competitors, minimum of " + minimum_players + " and maximum " + maximum_players + "?";
    public final static String playerNamesFile = "src/main/resources/card_player.csv";
    public final static int userIndex = 0;
    ...
    protected int getNumberOfPlayers(){
        return inOut.getInputIntegerBetween(numberOfCompetitors, minimum_players, maximum_players);
    }
    ...
    protected void initiatePlayers(int numberOfPlayers, String name) {
        ...
        createComputerCompetitors(numberOfPlayers - 2);
    }
