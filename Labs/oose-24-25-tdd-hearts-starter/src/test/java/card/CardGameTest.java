...
class CardGameTest {
    ...
    @Test
    void testCreateHandWithCatchException(){
        assertEquals(3, cardGame.createHandWithCatchException("SK,SQ,C3").size());
    }

    @Test
    void testCreateHandWithCatchExceptionNull(){
        assertNull(cardGame.createHandWithCatchException("SK,Sq,C3"));
    }
